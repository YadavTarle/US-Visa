...
from us_visa.entity.artifact_entity import DataIngestionArtifact,DataTransformationArtifact,ModelTrainerArtifact,ClassificationMetricArtifact
...
class ModelTrainer:
    def __init__(self,data_transformation_artifact: DataTransformationArtifact,
        ...
        """
        :param data_ingestion_artifact: output refrernce of data ingestion artifact stage
        :param data_tansformation_config: Configuration for data transforamtion
        """
    ...
    def get_model_object_and_report(self,train: np.array,test:np.array) -> Tuple[object,object]:
        ...
        Description : This function uses neuro_mf to get the best model object and its report
        
        Output      : Returns metric artifact object and best model object
        On Failure  : Raise Exception and write exception log
        """
        try :
