...
class SimipleStorageService:

    def __init__(self):
        s3_client = S3Client()
        self.s3_resouce = s3_client.s3_resource
    ...
    def read_object(object_name: str,decode: bool= True,make_readable: bool= False) -> Union[StringIO,str]:
        ...
        Description : This method readsthe object_name object with kwargs
        ...
        try: 
            func = (
                ...
                if decode is True else object_name.get()["Body"].read()
            )
    ...
    def get_bucket(self,bucket_name:str) -> Bucket:
        ...
        Description : This method get the bucket object based on the bucket_name
    ...
    def get_file_object(self,filename: str,bucket_name: str) -> Union[List[object],object]:
        ...
        Output      : list of objects or object is returnred bsed on filename
        On Failure  : Write an exception log and then raise an exception
        
        Version     : 1.2
        Revisions   : Moved setup to cloud
        """
        logging.inof("Entered the get_file_object method of S3Operation class")
    ...
    def load_model(self,model_name: str,bucket_name: str,model_dir: str = None) -> object:
        ...
        try:
            func = (
                lambda : model_name
                if model_dir is None else model_dir + "/" + model_name
            )
            model_file = func()
    ...
    def create_folder(self,folder_name: str,bucket_name:str) -> None:
        ...
        Description : This method crates a folder_name in bucket_name bucket
        
        Output      : Folder is created is s3 bucket
        On Failure  : Write an exception log and then raise an exception
        ...
        try:
            self.s3_resouce.Object(bucket_name,folder_name).load()
    ...
    def upload_file(self,from_filename: str,to_filename: str,bucket_name:str,remove:bool = True):
        ...
        Description : This method uploads the from_filename file to bucket_name bucket with to_filename
        ...
        try:
            ...
            self.s3_resouce.meta.client.upload_file(
