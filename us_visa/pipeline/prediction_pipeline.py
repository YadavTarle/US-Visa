...
class USvisaClassifier:
    def __init__(self,prediction_pipeline_config:USvisaPredictorConfig = USvisaPredictorConfig(),) -> None :
        ...
        try:
            ...
            self.prediction_pipeling_config = prediction_pipeline_config
    ...
    def predict(self,dataframe) -> str:
        """
        This is the method of USvisaClassifer
        Returns: Prediction in string format
        """
        try:
            logging.info("Entered predict method of USvisaClassifer class")
            model = USvisaEstimator(
                bucket_name=self.prediction_pipeling_config.model_bucket_name,
                model_path=self.prediction_pipeling_config.model_file_path,
            )
