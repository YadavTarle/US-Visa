...
class DataForm:
    ...
    async def get_usvisa_data(self):
        ...
        self.education_of_employee = form.get("edcation_of_employee")
        ...
        self.full_time_position = form.get("full_time_postion")
    ...
    async def trainRouteClient():
        try :
            ...
            return Response(f"Training failed with error: {e}")
